...
import { SlotDialogComponent } from '../../../../../../main/webapp/app/entities/slot/slot-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Slot Management Dialog Component', () => {
        let comp: SlotDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(SlotDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'slotListModification', content: 'OK'});
